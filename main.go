...
import (
	...
	clientset "github.com/rahulsidgondapatil/sample-depSvcController/pkg/client/clientset/versioned"
	informer "github.com/rahulsidgondapatil/sample-depSvcController/pkg/client/informers/externalversions/DepSvcResource/v1"
)
...
func getKubernetesClient() (kubernetes.Interface, clientset.Interface) {
	...
	myresourceClient, err := clientset.NewForConfig(config)
	if err != nil {
		logger.Fatalf("getClusterConfig: %v", err)
	}
...
func main() {
	...
	informer := informer.NewDepSvcResourceInformer(
		myresourceClient,
		metav1.NamespaceAll,
		0,
		cache.Indexers{},
